  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (settingsData && settingsData.length > 0) {
        ...
        const contactInfoObj = (typeof s.contact_information === 'object' && s.contact_information !== null)
          ? s.contact_information
          : {};

        mappedSettings = {
          storeName: s.store_name || 'LIVORA',
          storeNameEn: s.store_name_en || 'LIVORA',
          tagline: s.tagline || '',
          logo: s.logo || '/logo.svg',
          ...
          contactInformation: {
            address: s.address || contactInfoObj.address || '',
            phone: s.phone || contactInfoObj.phone || '',
            email: s.email || contactInfoObj.email || '',
            workingHours: s.working_hours || contactInfoObj.workingHours || ''
          },
          footerText: s.footer_text || '',
          defaultSEO: s.default_seo || { metaTitle: '', metaDescription: '' },
          currency: s.currency || { symbol: 'ر.ي', code: 'YER' },
        };
      }
